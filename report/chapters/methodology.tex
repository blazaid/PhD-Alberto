...
Para cada uno de los submodelos se han probado dos aproximaciones diferentes para comparar sus desempeños en las tareas por separado. Concretamente se han utilizado \acrshortpl{fcs}\index{sistema de control borroso} y \acrshortpl{mlp}\index{perceptrón multicapa} para modelar el comportamiento longitudinal y \acrshortpl{mlp}\index{perceptrón multicapa} y \acrshortpl{cnn}\index{red de convolución} para modelar el comportamiento en cambio de carril\index{lane-change}. La razón de estas elecciones se expone en sus respectivos capítulos.
