...
\marginnote{
	...
	%\includegraphics{fcs-best-architecture-next-tls-green-variable-partition}
	%\includegraphics{fcs-best-architecture-next-tls-yellow-variable-partition}
	%\includegraphics{fcs-best-architecture-next-tls-red-variable-partition}
