...
\begin{figure}[t]
	\centering
	\includegraphics[width=.45\textwidth]{fcs-best-architecture-next-tls-green-yellow-and-red-variable-partition}
...
\begin{figure}[!b]
	\centering
	\includegraphics{rms-all-in-training-and-validation-fcs-detail}
...
\begin{figure}
	\centering
	\includegraphics{rms-all-test-fcs-detail}[t]
...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=.45\textwidth]{fcs-test-comparison}}\qquad
	\subfloat[]{\includegraphics[width=.45\textwidth]{fcs-test-comparison-detail}}
...
\begin{figure}[!b]
	\centering
	\subfloat[Distancia a líder]{\includegraphics[width=.45\textwidth]{fcs-best-architecture-leader-distance-variable-partition}}\qquad
	\subfloat[Distancia a siguiente semáforo]{\includegraphics[width=.45\textwidth]{fcs-best-architecture-next-tls-distance-variable-partition}}\qquad
	\subfloat[Velocidad]{\includegraphics[width=.45\textwidth]{fcs-best-architecture-speed-variable-partition}}\qquad
	\subfloat[Velocidad a líder]{\includegraphics[width=.45\textwidth]{fcs-best-architecture-speed-to-leader-variable-partition}}
...
El error que se trata de minimizar es el error cuadrático medio entre los valores de aceleración del conjunto reales y los ajustados por el modelo. La Figura~\ref{fig:cf-rms-all-in-training-and-validation-mlp-detail} muestra la evolución de este error durante el proceso de entrenamiento.

\begin{figure}
	\centering
	\includegraphics{cf-rms-all-in-training-and-validation-mlp-detail}
	\caption[Evolución del error en entrenamiento en los \ac{mlp} para las arquitecturas seleccionadas]{Visión en detalle de la evolución del error en los conjuntos de entrenamiento y validación. Para cada arquitectura, el color más transparente se corresponde al error en el conjunto de validación..}
...
\begin{figure}
	\centering
	\includegraphics{cf-rms-all-test-mlp-detail}
...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=.45\textwidth]{cf-mlp-test-comparison}}\qquad
	\subfloat[]{\includegraphics[width=.45\textwidth]{cf-mlp-test-comparison-detail}}
	\caption[Comparación del perfil de aceleración real y el inferido por los modelos entrenados]{Comparación del perfil de aceleración real y el inferido por los modelos entrenados. En la visión general se puede observar, en transparente, el perfil real. A la derecha se amplía una pequeña sección del perfil para mostrar los diferentes ajustes de los modelos entrenados y cómo difieren del valor real.}
