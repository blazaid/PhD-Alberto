...
\begin{figure}[!b]
	...
	\caption[Representación de conjuntos de reglas como matriz]{Un ejemplo de representación matricial de un conjunto de reglas difusas. Las reglas activas se simbolizan como un $1$ (o como un valor real en caso de querer aplicar pesos).}
