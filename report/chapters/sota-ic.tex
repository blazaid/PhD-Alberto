...
\begin{figure}
	\centering
	\missingfigure[figheight=5cm]{Figura bonica que represente una matriz de reglas difusas}
	\caption[Representación de conjuntos de reglas como matriz]{En un controlador de tipo Takagi-Sugeno-Kang se prescinde del bloque de defuzzificación y los consecuentes de las reglas de inferencia son reemplazados por funciones. Por término general, estas funciones son polinomios.}
