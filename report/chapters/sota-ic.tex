...
\begin{figure}[t]
	\centering
	\subfloat[Mínimo]{\includegraphics[width=0.46\linewidth]{snorm-maximum}}\qquad
	\subfloat[Producto Algebráico]{\includegraphics[width=0.46\linewidth]{snorm-probabilistic-sum}}
