...
\begin{figure*}
	\centering
	\subfloat[]{\includegraphics[width=0.29\linewidth]{dropout-example-a}}\qquad
	\subfloat[]{\includegraphics[width=0.29\linewidth]{dropout-example-b}}\qquad
	\subfloat[]{\includegraphics[width=0.29\linewidth]{dropout-example-c}}
