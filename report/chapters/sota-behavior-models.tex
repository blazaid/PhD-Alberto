...
\begin{figure}[t]
	...
	\end{tikzpicture}
	\caption[Principales areas de aplicación de la \acrlongsp{ci} en los \acrlongplsp{its}]{Las principales areas de aplicación de la \acrlongsp{ci} en los \acrlongplsp{its} son el reconocimiento de patrones, la caracterización de conductores y la modelización de los mismos. Aunque son áreas de aplicación distintas, los estudios en general tienden a solaparse. Por ejemplo, las técnicas de reconocimiento de patrones pueden usarse como forma de extracción de características para una caracterización de conductores y a su vez esta caracterización puede usarse como base para su modelado.}
