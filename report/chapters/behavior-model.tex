...
El desarrollo del modelo de conrolador difuso se detalla en el apéndice \nameref{ch:fuzzy-controller-adjustment}. El resumen de los controladores ajustados se describe en la Tabla~\ref{tbl:adjusted-fcs}.
...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=.45\textwidth]{fcs-test-evolution}}\qquad
	\subfloat[]{\includegraphics[width=.45\textwidth]{fcs-test-evolution-detail}}
