...
\marginnote{
	A lo largo del capítulo, se utilizarán indistintamente los términos \gls{dvu}\index{driver-vehicle unit}, conductor y vehículo para referirse al mismo concepto. En caso de no ser así, se indicará de manera explícita.
}
...
\subsection{Microsimulación basada en \acrlongplsp{ca}\index{autómata celular}}
...
Estos modelos de microsimulación, debido a la propia naturaleza de los \gls{ca}\index{autómata celular}, se encuentran clasificados como simuladores de tiempo y espacio discreto, y se usan debido a su facilidad de implementación y a su eficiencia, ya que son fácilmente paralelizable.
