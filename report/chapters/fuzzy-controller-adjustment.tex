...
Esta sección ofrece un listado de las reglas borrosas generadas en el proceso de inferencia del \acrlongsp{fcs}\index{sistema de control borroso} para el modelo longitudinal del conductor genérico.
