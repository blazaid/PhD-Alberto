...
\begin{figure*}
	\centering
	\subfloat[Línea descendente]{\missingfigure[figwidth=0.29\linewidth]{Line desc}}\qquad
	\subfloat[Trapezoide]{\missingfigure[figwidth=0.29\linewidth]{Trapz}}\qquad
	\subfloat[Línea ascendente]{\missingfigure[figwidth=0.29\linewidth]{Line asc}}
	\caption[Funciones de pertenencia definidas como posición y desplazamientos][1.5em]{Las funciones de pertenencia (a) línea descendente, (b) trapezoidal y (c) línea ascendente. Éstas se definen como un punto de inicio seguido de tantos desplazamientos como sea necesario.}
