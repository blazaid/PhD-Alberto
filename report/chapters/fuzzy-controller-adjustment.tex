...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=.45\textwidth]{real-tip-controller-var-food}}\qquad
	\subfloat[]{\includegraphics[width=.45\textwidth]{real-tip-controller-var-service}}
...
\begin{figure}
	...
	\caption[Superficie de la función que modela el controlador difuso de ejemplo]{Las reglas y las particiones definen esta función. De ella obtendremos un conjunto de puntos aleatorio para comprobar si nuestra representación de \ac{fcs} como grafo computacional es capaz de ajustarse a ésta con la técnica del descenso del gradiente.}
...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=.28\textwidth]{ajusted-tip-controller-at-start-training}}\qquad
	\subfloat[]{\includegraphics[width=.28\textwidth]{ajusted-tip-controller-at-half-training}}\qquad
	\subfloat[]{\includegraphics[width=.28\textwidth]{ajusted-tip-controller-at-end-training}}
	\caption[Evolución del controlador difuso de acuerdo al conjunto de datos extraido del ]{Particiones difusas del controlador de ajustado. Estas figuras muestran la superficie del controlador ajustado (a) al comienzo del proceso de entrenamiento, (b) tras $250$ iteraciones sobre el conjunto de entrenamiento y (c) al final del proceso del entrenamiento.}
