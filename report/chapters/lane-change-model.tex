...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=.45\textwidth]{lc-mlp-acc-all-training-and-validation-detail}}\qquad
	\subfloat[]{\includegraphics[width=.45\textwidth]{lc-mlp-acc-all-test-detail}}
...
\begin{table}[b]
	...
	\begin{tabular}{ccccccc}
		...
		&                            &                         &                          & Training & Validation & Test \\ \hline
		$CNN_1$ & c16-4-18-v-d128-d0.1 & $10^5$ & $0.1$ & $0.995$ & $0.833$ & $0.823$ \\
		$CNN_2$ & c64-5-36-v-c256-3-5-v-d256-d128-d16-d0.1 & $10^6$ & $0.1$ & $0.506$ & $0.531$  & $0.518$ \\
		$CNN_3$ & c16-3-18-v-c32-3-18-v-c64-2-18-v-d128-d0.1 & $10^6$ & $0.1$ & $0.561$ & $0.569$ & $0.554$ \\ \hline
	\end{tabular}
\end{table}
