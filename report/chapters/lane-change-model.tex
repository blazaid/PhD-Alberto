...
\TODO{Poner las tablas de precisiones}
...
\begin{figure}
	\centering
	\includegraphics[width=.6\linewidth]{lc-mlp-model-confussion-matrix}
...
\begin{marginfigure}
	\centering
	\includegraphics[width=\linewidth]{lc-learning-rate-decay}
...
\begin{figure}
	\centering
	\subfloat[]{\includegraphics[width=.45\textwidth]{lc-cnn-training-accuracy-comparison}}\qquad
	\subfloat[]{\includegraphics[width=.45\textwidth]{lc-cnn-test-accuracy-comparison}}
	\caption[Comparación de las precisiones alcanzadas por los modelos de tipo \ac{mlp}]{Comparación de las precisiones alcanzadas por los modelos de tipo \ac{mlp}.}
