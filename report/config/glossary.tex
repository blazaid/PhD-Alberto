...
\newglossaryentry{aimsun}{
	name=Aimsun,
	description={\textit{Advanced Interactive Microscopic Simulator for Urban and Non-Urban Networks}. Simulador de tráfico a nivel micro y meso desarrollado por la Universidad Politécnica de Cataluña (UPC). También se refiere al nombre de la compañía que se formó en el seno de la Universidad y que actualmente posee los derechos sobre el paquete de simulación. Url: \url{https://www.aimsun.com}}
}
