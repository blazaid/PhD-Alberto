...
\begin{fullwidth}
	...
	The study focuses into two existent characteristics inside this type of simulations: the longitudinal and \idx{lane-change} behaviours. The study concludes that \acrlong{ann}\index{red neuronal artificial} based techniques are far superior in modelling human behaviour. In \idx{lane-change} the best among them are \Acrlongpl{cnn}, which are better in perceiving the surrounding environment patterns than \Acrlongpl{mlp}.
