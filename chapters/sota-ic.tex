...
¿A qué se refieren con autonomía? A que pueden actuar sin intervención humana o de otros sisetmas, es decir, tienen control sobre su estado interno y su comportamiento.
...
\TODO{Quizá en lugar de enumerar todas las arquitecturas, habría que indicar que cada uno de lso autores enumera una serie de arquitecturas o que todas se basan en el mismo patrón y definirlo}.
