...
Un \gls{ga} es un algoritmo iterativo donde se aplica una serie de pasos inspirados en el funcionamiento de los mecanismos de la evolución y la genética a una población de individuos donde cada uno simboliza una solución a nuestro problema. Éstos fueron introducidos por John Henry Holland en su libro \textit{\enquote{Adaptation in Natural and Artificial Systems}} (\cite{Holland1975}) y constituyen una familia de algoritmos de optimización muy potentes y versátiles.
...
\begin{itemize}
	\item \textbf{Inicialización}. \TODO{Describir}.
	\item \textbf{Selección}. \TODO{Describir}.
	\item \textbf{Recombinación}. También llamado cruce. \TODO{Describir}.
	\item \textbf{Mutación}. \TODO{Describir}.
	\item \textbf{Reemplazo}. \TODO{Describir}.
\end{itemize}

Sin embargo, dentro de la \gls{cev} siguen existiendo familias de algoritmos consideradas, en un principio, diferentes. Para ver las diferencias, empezaremos describiéndo qué es un \gls{ga}
...
Sin embargo, siguen existiendo familias de algoritmos cvonsideradas en un principio diferentes.es. Por un lado tenemos las \glspl{es} 
