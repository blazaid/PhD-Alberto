...
\newthought{car following}

Un poco de su evolución

\newthought{Llega el lane changing}
...
\newthought{Con los modelos psico-físicos se llegó a la conclusión de que existían diferentes situaciones} en las que los estímulos y las respuestas obedecían a diferentes umbrales y que, por tanto, los modelos de tipo \textit{\idx{car-following}} no eran sino una clase más de un conjunto más amplio de modelos de aceleración (imagen~\ref{fig:acceleration-model-classes}).
...
\newthought{Agrupar en un mismo modelo las diferentes clases de modelo de aceleración} es un trabajo que se empezó a desarrollar a partir de los años $90$ debido, en parte, a la proliferación de diferentes modelos de aceleración. El principal problema reside en que cuantos más regímenes se tratan de agrupar en un mismo modelo, más aumenta el número de factores a generalizar y ajustar.
