...
Hablar aquí de que los modelos de este nivel hacen uso de una nomenclatura que explicamos aquí. Poner también una ilustración estupendísima indicando qué es qué en cada uno de los vehículos en una vía. No debería ocupar más de 3-4 párrafos y una figura.
...
Las primeras menciones sobre modelos de aceleración se atribuyen a \cite{reuschel1950fahrzeugbewegungen} y \cite{Pipes1953} por sus trabajos sobre el concepto de \textit{\idx{car-following}}.
